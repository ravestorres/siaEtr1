...
<div class="container">
                ...
                <tbody>
                    <?php while ($row = $clients->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($row['freelancer_id']); ?></td>
                            <td><?php echo htmlspecialchars($row['user_id']); ?></td>
                            <td><?php echo ucfirst(htmlspecialchars($row['report_reason'])); ?></td>
    ...
    <div class="mt-4">
        <?php
        // Fetch freelancers
        $stmt = $conn->prepare("SELECT* FROM reports_client");
        $stmt->execute();
